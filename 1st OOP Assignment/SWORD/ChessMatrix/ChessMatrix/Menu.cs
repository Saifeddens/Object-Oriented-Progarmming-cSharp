...
namespace chessMat
{
    public class Menu
    {
        private List<Chess> vec = new List<Chess>();
        ...
        private void SetElement()
        {
            ...
            do
            {
                ...
                catch (Chess.ReferenceToNullPartException)
                {
                    Console.WriteLine("Only the elements in a chess patern may be rewritten");
                }
            } while (true);
        }
        ...
        private void Sum()
        {
            ...
            catch (Chess.DifferentSizeException)
            {
